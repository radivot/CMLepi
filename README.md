...
This shows 1200 US deaths by CML each year. The large drop in numbers in 1999 merely reflects 
removing CMML from the definition of CML; tyrosine kinase inhibitor (TKI) mediated drops in numbers of deaths by CML began in 2001. Also 
generated by the script above is this plot
![Figure 2B](man/figures/2B_deathAges.png)
This plot shows plateauing of the mean age at death, perhaps to a value of ~75 years.  
...
This plot shows that there has been very little prevention of death by CML in elderly populations. 
Note that values here are small because they are rate-limited by CML incidence.  
