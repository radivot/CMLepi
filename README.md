...
This plot shows ~1200 deaths by CML in the US each year. Note that the large drop in numbers in 1999 is an artifact of 
removing CMML from the definition of CML. Tyrosine kinase inhibitor (TKI) mediated drops in numbers begin in 2001. 

Also generated by the script above is this plot
![Figure 2B](man/figures/2B_deathAges.png)
This plot shows plateauing of the mean age at death, perhaps to a value of roughly 75 years.  
