...
This shows ~1200 US deaths by CML each year. The large drop in numbers seen in 1999 is merely an artifact of 
removing CMML from the definition of CML; tyrosine kinase inhibitor (TKI) mediated drops in numbers begin in 2001. 

Also generated by the script above is
![Figure 2B](man/figures/2B_deathAges.png)
which shows plateauing of the mean age at death, perhaps to a value of ~75 years.  
...
which shows that there has been very little prevention of death by CML in elderly populations. 
