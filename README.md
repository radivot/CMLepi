...
average life expectancy of a CML patient is thus >13.2 (=66k/5k) years, as the system may not yet
be at steady state.

There are two codes used to define CML, an older and more stable code 9863, and a newer code 9875 that defines it
based on polymerase chain reaction detection of the *BCR::ABL1* transcript. This code usage is dynamic, as 9875 replace 
9863 as shown in the plot generated by the code shown below. Also shown in this code is the enormous amount of 
misclassification of CML patient deaths by CML as deaths by other leukemias.
...
Thus, at a mean age of 59 for 9863-coded diagnoses and a normal LE at 59 of 24.5 years,  ages of such patient deaths 
leveling at ~75 years suggest LEs are actually 16 years, not 24.5. 
Thus, on average, CML patients lose ~8 years of life, i.e. roughly a third. 
