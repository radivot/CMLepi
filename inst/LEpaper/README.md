These are the **scripts** that we used to create the figures (e.g. N_XXX.R makes Figure N) in our paper
...
It should then be possible to run the others. Supplementary figure script names begin with an S.  Note that
